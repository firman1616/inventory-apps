...
class Master extends CI_Controller {
    ...
    public function brand()
    {
        $data = [
            ...
            'name'	=> $this->session->userdata('nama'),
            'title' => 'Master Brand',
            'conten'=> 'conten_user/master_brand',
    ...
    public function category_item()
    {
        $data = [
            ...
            'conten'=> 'conten_user/master_category_item',
            'tipe'  => $this->m_data->item_user($this->session->userdata('dept_user'))
        ];
        $this->load->view('template_user/conten',$data);
    }
    ...
    public function tambah_category_item()
    {
        ...
        $this->m_data->simpan_data($table,$data);
        redirect('user/Master/category_item');
    }
    ...
    public function sub_category()
    {
        $data = [
            ...
            'conten'=> 'conten_user/master_sub_category_item',
            'sub'   => $this->m_data->sub_item_user($this->session->userdata('dept_user')),
            'master' =>  $this->m_data->item_user($this->session->userdata('dept_user'))
            // $this->m_data->get_data('tbl_master_tipe')
        ];
        $this->load->view('template_user/conten',$data);
    }
    ...
    public function tambah_sub()
    {
        ...
        $this->m_data->simpan_data($table,$data);
        redirect('user/Master/sub_category');
    }
