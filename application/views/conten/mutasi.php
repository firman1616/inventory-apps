...
<div class="card shadow mb-4 collapse" id="collapseExample">
    ...
    <div class="card-body">
    <form action="<?= base_url('admin/Mutasi/add_mutasi') ?>" method="post">
    <div class="row">
    ...
    <div class="row">
        <div class="form-group col-md-6 col-lg-6 col-xs-6">
            ...
            <input type="datetime-local" class="form-control" id="tgl_mutasi" name="tgl_mutasi" required>
        </div>
    </div>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                foreach ($mutasi->result() as $row) { ?>
                    <tr>
                        ...
                        <td>
                        <a href="<?= base_url('admin/Mutasi/v_edit/'.$row->id_mutasi) ?>"><button type="submit" class="btn btn-warning"><i class="fa  fa-edit"></i></button></a>
                        <a href="<?= base_url('admin/Mutasi/delete_mutasi/'.$row->id_mutasi) ?>" class="hapus-mutasi btn btn-danger"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php }
                 ?>
