                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('user/Master/hapus_category_item/'.$row->id_master_tipe) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        <form action="<?= base_url('user/Master/tambah_category_item') ?>" method="post">
...
foreach ($tipe->result() as $row) { 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        <form action="<?= base_url('user/Master/edit_category_item/'.$row->id_master_tipe) ?>" method="post">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Modal title</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
