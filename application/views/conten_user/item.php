...
<a href="<?= site_url('user/Item/v_tambah') ?>" class="btn btn-primary">Add Item</a>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                foreach ($item_list->result() as $row) { 
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('user/Item/v_edit/'.$row->id_item) ?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                            <a class="hapus-item btn btn-danger" href="<?= base_url('user/Item/hapus_item/'.$row->id_item) ?>"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
