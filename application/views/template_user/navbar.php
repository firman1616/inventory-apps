            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= site_url('user/Master/brand') ?>">Master Brand</a>
                        ...
                        <a class="collapse-item" href="<?= site_url('user/Master/category_item') ?>">Master Type</a>
                        <a class="collapse-item" href="<?= site_url('user/Master/sub_category') ?>">Master Sub Type</a>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Welcome, <?= $name; ?>"
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?= site_url('assets/template/') ?>img/undraw_profile.svg">
                            </a>
